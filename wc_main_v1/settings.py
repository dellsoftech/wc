"""
Django settings for wc_main_v1 project.
...
ALLOWED_HOSTS = ['wc-production-8c95.up.railway.app', '127.0.0.1']
...
WSGI_APPLICATION = 'wc_main_v1.wsgi.application'
